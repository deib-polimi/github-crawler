...
pool.addSearch(Search("kubernetes_1", 'kind+Pod', {'extension': 'yml'}))
pool.addSearch(Search("kubernetes_2", 'kind+ReplicationController', {'extension': 'yml'}))
pool.addSearch(Search("kubernetes_3", 'kind+Service', {'extension': 'yml'}))
pool.addSearch(Search("kubernetes_4", 'kind+Deployment', {'extension': 'yml'}))
pool.addSearch(Search("kubernetes_5", 'kind+Namespace', {'extension': 'yml'}))
pool.addSearch(Search("kubernetes_6", 'kind+Node', {'extension': 'yml'}))
